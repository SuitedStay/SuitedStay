      ...
      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow">
        ...
        <div className="p-6">
          ...
          <p className="text-sm text-gray-700 mb-4 line-clamp-2">
            {hotel.description ? hotel.description.substring(0, 120) + '...' : 'Luxury accommodation with exceptional service and amenities.'}
          </p>
          ...
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <a href="/" className="text-xl font-bold text-gray-900">
                Suited<span className="text-gold">Stay</span>
              </a>
        ...
        <div className="bg-gradient-to-b from-gray-50 to-white">
          <div className="max-w-4xl mx-auto px-6 py-16 text-center">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4 leading-tight">
              The World's Most 
              <span className="text-gold"> Exclusive Hotels</span>
            </h1>
